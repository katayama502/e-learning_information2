                        ...
                        (() => {
                            ...
                            return (
                                <>
                                    <iframe
                                        ref={iframeRef}
                                        src={`${embedUrl}?autoplay=1&mute=0&controls=0&loop=1&playlist=${videoId}&rel=0&modestbranding=1&enablejsapi=1`}
                                        className="w-full h-full pointer-events-none"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowFullScreen
                                        style={{ pointerEvents: 'none' }}
                                    />
                                    {/* Clickable overlay for YouTube pause/play */}
                                    <div className="absolute inset-0 z-10 cursor-pointer" onClick={(e) => { e.stopPropagation(); togglePlay(); }} />
                                    {/* Play/Pause Icon Overlay for YouTube */}
                                    {!isPlaying && (
