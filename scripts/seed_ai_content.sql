...
VALUES
  ...
  ('c1020102-0000-0000-0000-000000000001', 'b1000102-0000-0000-0000-000000000001',
   '【DX成功事例】なぜか失敗してしまう日本企業のDX導入要因と成功への道',
   '日本企業がDX導入で失敗する要因と、成功への道筋を解説します。',
   'https://www.youtube.com/watch?v=PPkOfsqAxDQ', '25:00', 2, 'video'),
  ...
  ('c1020104-0000-0000-0000-000000000001', 'b1000102-0000-0000-0000-000000000001',
   'AIが推進するDX：日本企業のデジタル変革とは',
   'AIとDXの融合により、日本企業がどのようにデジタル変革を進めるかを解説。',
   'https://www.youtube.com/watch?v=g4eMLAgxwl0', '28:00', 4, 'video')
ON CONFLICT (id) DO NOTHING;
